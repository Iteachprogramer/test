            ...
            <div class="form-group highlight-addon field-tree-url_value">
                ...
                <div id="menu-value">
                    ...
                    if ($node->url_type == 'category')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\modules\post\models\Post::find()->all(), 'slug', 'title_uz' ))->label(false);
                    elseif($node->url_type == 'page')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\modules\page\models\Page::find()->all(), 'identifikator', 'slug' ))->label(false);
                    elseif($node->url_type == 'leader')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\backend\modules\leader\models\Leader::find()->all(), 'slug', 'title_uz' ))->label(false);
